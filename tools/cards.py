...
STANDING = {
    ...
    "against": ("WHAT IT STOPS", "Reported, attributed, never tested",
                ...
                "This project does not write that a charm works, and does not write that it does not."),
    ...
    "quiz": ("PICK ME ONE", "Six questions, and a charm",
             ...
             "A lookup, not an oracle. Nothing you click leaves your browser."),
    "search": ("SEARCH", "Spell it however you spell it",
               "nazar, nazar boncuğu, evil eye bead",
               "Runs in your browser over every record. Nothing is sent anywhere."),
